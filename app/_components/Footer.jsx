...
const Footer = () => {
  ...
  <div className="text-center">
    ...
    <div className="mt-3">
      <p className="text-gray-500">We're part of  <a className="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400" href="#">Wathb</a> family.</p>
      <p className="text-gray-500">© wajbah. 2024 Egypt. All rights reserved.</p>
    </div>
