...
const Header = () => {
    ...
    return (
      ...
      {isVisible && (
        ...
        <nav className="flex items-center justify-between py-5 lg:px-32 md:px-20 px-16
         bg-white  " aria-label="Global"> {/* Adjusted padding here */}
          ...
          <div className=" lg:flex lg:flex-1 lg:justify-end">
            ...
            <Dialog>
              ...
              <button
                className="rounded-xl bg-white px-3.5 py-2.5 text-sm font-semibold  text-gray-900  hover:bg-grey-10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                Log in
              </button>
              </DialogTrigger>
            ...
            <Dialog>
              <DialogTrigger asChild>
              <button
                 className="rounded-xl bg-green-90 px-3.5 py-2.5 text-sm font-medium text-white   focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
               >
                 Sign up
              </button>
              </DialogTrigger>
