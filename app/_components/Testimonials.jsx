...
<div className="overflow-hidden bg-green-50">
  ...
  <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div className="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
      ...
      Wajbah in the Hearts of Many: Transforming Lives, One Bite at a Time
      </h2>
    </div>
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col bg-white rounded-xl ">
          <div className="flex-auto p-4 md:p-6">
            <p className="text-base italic md:text-lg text-gray-800 ">
              " As a student with a hectic schedule, Wajbah has been a lifesaver for me. with delicious homemade meals, I can focus on my studies without worrying about cooking. Wajbah has truly made my life easier and tastier!"
            </p>
          </div>
          ...
          <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 ">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <img className="size-8 rounded-full sm:h-[2.875rem] sm:w-[2.875rem]" src="/omar.jpg" alt="Image Description"/>
              </div>
      ...
      <div className="flex h-auto">
        <div className="flex flex-col bg-white rounded-xl ">
          <div className="flex-auto p-4 md:p-6">
            <p className="text-base italic md:text-lg text-gray-800 ">
              " Wajbah's homemade meals has revolutionized my routine. No matter how busy life gets, I rely on Wajbah for fresh, flavorful dishes . It's not just food; it's a seamless solution that elevates my day."
            </p>
          </div>
          ...
          <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 ">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <img className="size-8 rounded-full sm:h-[2.875rem] sm:w-[2.875rem]" src="/ahmed.jpg" alt="Image Description"/>
              </div>
              ...
              <div className="grow ms-3">
                ...
                <p className="text-xs text-gray-500 ">
                  lecturer @Fayoum University | Fayium
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="flex h-auto">
        <div className="flex flex-col bg-white rounded-xl ">
          <div className="flex-auto p-4 md:p-6">
            <p className="text-base italic md:text-lg text-gray-800 ">
              " As a busy businesswoman, finding time to cook was always a challenge. Wajbah has revolutionized the way I eat by providing me with healthy homemade food delivered straight to my office. It's a game-changer for my busy lifestyle!"
            </p>
          </div>
    ...
    <div className="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
      ...
      <div>
        ...
        <p className="mt-1 text-white">partner with wajbah</p>
      </div>
